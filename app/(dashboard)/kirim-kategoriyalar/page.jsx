...
export default function KirimKategoriyalarPage() {
  ...
  const handleSave = async (data) => {
    const result = editCat
      ? await updateIncomeCategory(editCat.id, data)
  ...
  const handleDelete = async () => {
    const result = await deleteIncomeCategory(deleteId);
  ...
  return (
    <div className="animate-fade-in">
      <Header title="Kirim Kategoriyalar" />
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold">Kirim Kategoriyalari</h2>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <Badge variant="income" className="mt-0.5 text-[10px]">
                          {cat._count?.incomes || 0} ta kirim
                        </Badge>
                      </div>
                    </div>
      ...
      <ConfirmDialog
        ...
        description="Bu kategoriyani o'chirishdan oldin unga bog'liq barcha kirimlarni o'chiring."
      />
    </div>
  );
}
